...
class  _PantallaTresScreenState extends State<PantallaTresScreen> with WidgetsBindingObserver{
  ...
  CameraPosition positionInitial = CameraPosition(target: LatLng(21.155418333333334, -88.15036666666668) , zoom : 15 );
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        Text("San jose", style: TextStyle( color: Colors.grey, fontSize: 11 ), textAlign: TextAlign.end),
                                      ],
                                    )
                                ...
                                Row(
                                    children: [
                                      Text("Avaliable spaces", style: TextStyle( color: Colors.grey, fontSize: 11) )
                                    ],
                                ),
                                Container(
                                  margin: const EdgeInsets.symmetric( vertical: 5, horizontal: 0),
                                ...
                                Row(
                                  children: [
                                    ...
                                    SizedBox( width: 5 ),
                                    Text("124 meters walk", style: TextStyle( color: Colors.grey, fontSize: 11 ))
                                  ],
                                )
                              ],
                            )
